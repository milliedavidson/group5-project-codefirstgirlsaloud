...
Need to link up user selections here
"""
user_input_subject = "fiction+thriller"  # Can add or remove 'bestseller' here
desired_book_length = "long"  # Choose from 'short', 'medium', 'long'
